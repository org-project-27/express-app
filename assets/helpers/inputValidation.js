...
export function validRequiredFields(requiredFields = [], payload){
    return (requiredFields.filter(item => !payload[item]));
}
...
export function validatePasswordStrength(passwordString) {
    let strength = 0;
    if(passwordString){
